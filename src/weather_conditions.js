...
const nightImages = require.context(
  "./assets/weather/64x64/night",
  true,
  /\.png$/,
);
...
class Condition {
  ...
  set(condition){
    const {type, dayImage, nightImage} = condition; 
    console.log(type,dayImage,nightImage); 
  }
...
for (let i = 0; i < weatherConditions.length; i++) {
  ...
  condition.set(weatherConditions[i], dayImageList[i], nightImageList[i]); 
